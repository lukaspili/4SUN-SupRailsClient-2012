 ...
 */
package com.supinfo.suprailsclient;

import com.supinfo.suprails.ws.CustomerOrderResource;
import com.supinfo.suprails.ws.Trip;
import com.supinfo.suprails.ws.TripResource;
import java.net.URI;
...
public class SupRailsClient {
    ...
    private static final String TRIP_QNAME = 
            "{http://ws.suprails.supinfo.com/}soap/trips";
    
    private static final String CUSTOMERORDER_QNAME = 
            "{http://ws.suprails.supinfo.com/}soap/customerorders";
